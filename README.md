...
2. Implement feed generation logic in `src/algos`
   ...
   For inspiration, we've provided a very simple feed algorithm (`desi`) that returns all posts related to desis.
